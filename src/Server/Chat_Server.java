...
public class Chat_Server extends UnicastRemoteObject implements Server_Interface {
	String line = "---------------------------------------------\n";
	...
	public static void main(String[] args) {
		...
		try{
			Server_Interface hello = new Chat_Server();
	...
	private void registerChatter(String[] details){		
		try{
			Client_Interface nextClient = ( Client_Interface )Naming.lookup("rmi://" + details[1] + "/" + details[2]);
